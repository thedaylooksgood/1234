        ...
        >
          ...
          <AnimatePresence>
            {isCardOpen && <motion.div
              className="absolute inset-0 bg-white max-[350px]:-top-6 min-h-[350px] rounded-3xl p-6 shadow-xl shadow-rose-100 flex flex-col items-center justify-center overflow-y-auto"
