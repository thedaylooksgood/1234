...
export default function BirthdayCelebration() {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        <h1 className="text-4xl sm:text-5xl font-bold text-center text-pink-600 mb-2">Happy Birthday Hafiza!</h1>
        ...
        >
          ...
          <AnimatePresence>
            {isCardOpen && <motion.div
              className="absolute inset-0 bg-white rounded-3xl p-6 shadow-xl shadow-rose-100 flex flex-col items-center justify-start overflow-y-auto min-h-[400px] max-h-[90vh] pt-10 pb-6"
            ...
            >
              <div className="text-center">
                ...
                You are my love my favourite person I always wanted to see you on top with me or without me I know I made mistake all time that hurt you I am sorry for that but you are my special person without you I can't imagine my life I am just want to be close to you always
                </p>
                <p className="text-pink-600 font-medium text-sm sm:text-base mt-4">A Small talk with you make my day and when I see a glimpse of you I think I see a most beautiful thing in this world you love me or not but I always love you and pray to god that you will be my future partner and always be happy and enjoy your day 💖</p>
                <div className="flex justify-center">
                  <motion.div
                    animate={{
                      scale: [1, 1.2, 1],
